...
file(APPEND ${OUTPUT_FILE} "// Generated on: ${CURRENT_TIME}\n")
file(APPEND ${OUTPUT_FILE} "// =============================================================================\n")
...
execute_process(
    COMMAND ${CXX_COMPILER} -std=c++23 -c ${TEST_MAIN} -o ${CMAKE_CURRENT_BINARY_DIR}/test.js -lembind -sEXPORTED_RUNTIME_METHODS=['UTF8ToString']
